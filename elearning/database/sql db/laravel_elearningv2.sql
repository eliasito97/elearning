...
INSERT INTO `permissions` (`id`, `role_id`, `name`, `created_at`, `updated_at`) VALUES
                                                                                    ...
                                                                                    (375, 3, 'student.create', '2024-01-02 00:45:53', '2024-01-02 00:45:53');
...
ALTER TABLE `coupons`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `coupons_code_unique` (`code`(191));
...
ALTER TABLE `instructors`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `instructors_contact_en_unique` (`contact_en`(191)),
    ADD UNIQUE KEY `instructors_email_unique` (`email`(191)),
    ADD UNIQUE KEY `instructors_contact_bn_unique` (`contact_bn`(191)),
...
ALTER TABLE `students`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `students_email_unique` (`email`(191));
...
ALTER TABLE `users`
    ...
    ADD UNIQUE KEY `users_contact_en_unique` (`contact_en`(191)),
    ADD UNIQUE KEY `users_contact_bn_unique` (`contact_bn`(191)),
