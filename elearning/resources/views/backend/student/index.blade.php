        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('student.index')}}">{{ __('Students List') }}</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('All Students List') }} </h4>
                                <a href="{{route('student.create')}}" class="btn btn-primary">{{ __('Add new') }}</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><img class="rounded-circle" width="35" height="35"
                                                        src="{{asset('public/uploads/students/'. ($d->image ? $d->image : 'user_Default.png'))}}" alt=""></td>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="7" class="text-center">{{ __('No Student Found') }}</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item"
                                                        href="{{route('student.edit', encryptor('encrypt',$d->id))}}">{{ __('Edit') }}</a>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <div class="profile-photo">
                                                <img src="{{asset('public/uploads/students/'.($d->image ? $d->image : 'user_Default.png'))}}" width="100"
                                            ...
                                            <ul class="list-group mb-3 list-group-flush">
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">{{ __('Email') }}</span>
                                                    <strong>{{$d->email}}</strong>
                                                </li>
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">{{ __('Gender') }}</span>
                                                    <strong>{{ $d->gender == 'male' ? __('Male') : ($d->gender == 'female' ? __('Female') : __('Other')) }}</strong>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="card card-profile">
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <p class="mt-3 px-4">{{ __('Student Not Found') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
