                            ...
                            <div class="auth-form">
                                ...
                                <form action="{{route('register.store')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label><strong>{{__('Full Name')}}</strong></label>
                                        <input type="text" class="form-control" value="{{old('name')}}" name="name"
                                            id="name" placeholder="{{__('Enter your Full Name')}}">
                                        @if($errors->has('name'))
                                        <small class="d-block text-danger">{{$errors->first('name')}}</small>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <label><strong>{{__('Your email')}}</strong></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{old('contact_en')}}"
                                            name="contact_en" id="contact_en" placeholder="{{__('Enter Contact No')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password_confirmation"
                                            id="password_confirmation" placeholder="{{__('Re-enter Password')}}">
                                    </div>
